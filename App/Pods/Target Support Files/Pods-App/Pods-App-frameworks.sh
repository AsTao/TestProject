...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SKPhotoBrowserDTCustom/SKPhotoBrowserDTCustom.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ZLPhotoBrowserDTCustom/ZLPhotoBrowserDTCustom.framework"
